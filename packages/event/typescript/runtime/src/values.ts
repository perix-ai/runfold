/**
 * Lossless JSON and immutable-value helpers.
 *
 * Copied verbatim from DeepSeek Harness `packages/util/values/src/index.ts`
 * (0.1.2-alpha.3, dd6322d6); only this header differs. MIT licensed.
 */
